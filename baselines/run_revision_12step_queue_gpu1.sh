...
# Existing usable results:
# - Graph WaveNet METRLA: train_metrla.log
# - DMFGCRN PEMSD8: experiments/PEMSD8/20260412095707/42/run.log
# - MTEGCRN PEMSD8: experiments/PEMSD8/20260411230833/12/run.log
run_one dmfgcrn METRLA 42
